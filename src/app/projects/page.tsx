        ...
        <div className="space-y-16">
            <header className="grid grid-cols-1 md:grid-cols-12 gap-6">
                <div className="md:col-span-12">
                    <h1 className="text-xs font-bold uppercase tracking-[0.2em] mb-4 !text-black dark:!text-white">Selected Works</h1>
                </div>
            </header>
                ...
                {projects.map((project, index) => (
                    ...
                    >
                        ...
                        <div className="flex justify-between items-baseline border-b border-gray-200 dark:border-gray-800 pb-2">
                            <h2 className="text-xl font-bold tracking-tight !text-black dark:!text-white">{project.title}</h2>
                            <span className="text-xs !text-black dark:!text-white font-mono">{project.year}</span>
                        </div>
                        <div className="flex justify-between items-start text-sm !text-black dark:!text-white">
